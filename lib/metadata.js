...
exports.extract = function(fileref, callback) {

    const srcBucket = fileref.s3Bucket;
    const srcKey = fileref.s3Key;
    
    return new Promise(function (resolve, reject) {
        var filemeta = ['label1', 'label2'];
        // resolve({ 'img': fileref, 'filemeta': filemeta });
        resolve(filemeta);
    });
